...
export const navLinks = [
  ...
  { href: "/service/interior-painting", label: "Services", icon: Brush },
  { href: "/paint-type/latex", label: "Paint Types", icon: Paintbrush },
  { href: "/finish/matte", label: "Finishes", icon: Palette },
